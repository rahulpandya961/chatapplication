...
if(isset($_POST["register"]))
{
    ...
    else
    {
        if($user_object->save_data())
        {
            ...
            $mail->Username   = 'dashrath.prajapati@theonetechnologies.co.in';                     // SMTP username
            $mail->Password   = 'Dash#123';

            $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;

            $mail->Port = 587;

            $mail->setFrom('dashrath.prajapati@theonetechnologies.co.in', 'TOT Chat');
            ...
            <p>Thank you for registering for Chat Application Demo.</p>
                ...
                <p><a href="http://192.168.1.177/dashrath/test/ratchet-chat-application-source-code/verify.php?code='.$user_object->getUserVerificationCode().'">Click to Verify</a></p>
                <p>Thank you...</p>
            ';
