	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-lg-8">
						...
						<div class="'.$row_class.'">
							<div class="col-sm-10">
								<div class="shadow-sm alert '.$background_class.'">
									...
									<img src="'.$chat["image"].'" height="100px" width="100px" />
								</div>
							</div>
						</div>
						';
				...
				<form method="post" id="chat_form" data-parsley-errors-container="#validation_error" enctype="multipart/form-data">
					<div class="input-group mb-3">
						<div class="chat_message_area"> 	
							<input type="text" class="form-control" id="chat_message" name="chat_message" placeholder="Type Message Here"  required>
							<input type="file" name="uploadFile" id="uploadFile" accept=".jpg,.png" />
							<img src="" width="200" style="display:none;" id="image_user" />
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		conn.onmessage = function(e) {
		    ...
		    var html_data = "<div class='"+row_class+"'><div class='col-sm-10'><div class='shadow-sm alert "+background_class+"'><b>"+data.from+" - </b>"+data.msg+"<br /><img src=" + data.image  + " height='100px' width='100px' /><div class='text-right'><small><i>"+data.dt+"</i></small></div></div></div></div>";
		...
		$('#chat_form').on('submit', function(event){
			...
			{
				// alert('xfdfd');return false;

				var user_id = $('#login_user_id').val();
				var message = $('#chat_message').val();
				var image = $('#image_user').attr('src');
				// var image_extension = $('#uploadFile').val().split('.').pop().toLowerCase();
				var data = {
					userId : user_id,
					msg : message,
					image: image,
